...
weight: 30
type: docs
description: 'Link Workday OfficeConnect data into Word documents and PowerPoint slides
  for board books, narrative reports, and presentation-ready decks.
...
Workday OfficeConnect isn't only an Excel tool. Linked tables and charts can flow into Word documents (board narratives, MD&A drafts, investor letters) and PowerPoint slides (board packs, monthly reviews, quarterly updates) — and refresh with one click when the period changes.
