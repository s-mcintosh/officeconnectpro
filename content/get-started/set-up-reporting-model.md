...
linkTitle: "Reporting Model Setup"
weight: 4
description: >
...
→ [Sign In & Create Your First Tenant](/get-started/sign-in-create-tenant/) to connect OfficeConnect to your Workday Financials instance
→ [Financials vs Adaptive Planning](/build-reports/financials-vs-adaptive-planning/) for an overview of how the two data sources differ in OfficeConnect
