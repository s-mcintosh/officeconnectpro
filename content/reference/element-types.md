...
tags: ["reference", "reporting", "fp-and-a", "admin-power-user"]
---
...
Where to find: `Reporting pane → Accounts`. See [Add Elements](/build-reports/add-elements/).
...
Where to find: `Reporting pane → Versions`. See [Compare Planning Versions](/build-reports/compare-planning-versions/).
...
Where to find: `Reporting pane → Time`. See [Time and Contexts](/build-reports/time-and-contexts/).
...
Where to find: `Reporting pane → Levels`. See [Department P&L Report](/build-reports/department-pl-report/).
...
Where to find: `Reporting pane → Attributes`. See [Custom Dimensions & Attributes](/build-reports/custom-dimensions-attributes/).
...
In the Financials data source, custom dimensions are called **Worktags**. See [Worktag Combinations](/build-reports/financials/worktag-combinations/).
...
- [Add Elements](/build-reports/add-elements/) — step-by-step on dragging each type into a worksheet.
- [Filter Data](/build-reports/filter-data/) — how Attributes and Custom Dimensions work as filters.
