...
tags: ["adaptive-planning", "fp-and-a", "admin-power-user", "how-to"]
aliases:
...
See [Sign In & Create a Tenant](/admin/configure/sign-in-create-tenant/) for the full tenant setup walkthrough.
...
See [Build Your First Report](/build-reports/build-first-report/) for the standard tutorial.
...
- [Optimize Performance for Large Models](/performance/optimize-performance/) — if refresh feels slow on Mac.
- [Authentication Token Errors](/troubleshoot/authentication-token-errors/) — if sign-in misbehaves.
