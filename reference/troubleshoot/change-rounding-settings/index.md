...
If your report includes percentages, rounding to Thousands will distort them — `25.25%` becomes `0.0002525`. See [Display Percentage Values](/reference/troubleshoot/display-percentage-values/) for the fix.
