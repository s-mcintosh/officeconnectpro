...
url: "https://officeconnectpro.com/wiki/system-requirements/"
...
→ [Install OfficeConnect as an End User](/wiki/install-end-user/) if you're setting up your own machine.

→ [Install OfficeConnect as an IT Admin](/wiki/install-admin/) if you're deploying to multiple users.
