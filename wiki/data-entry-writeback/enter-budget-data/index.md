...
url: "https://officeconnectpro.com/wiki/data-entry-writeback/enter-budget-data/"
...
**What you'll need:**
- Workday OfficeConnect installed and connected to an Adaptive Planning tenant ([Get Started](/wiki/))
...
- Protect the workbook before sharing — see [Lock and Protect Reports](/wiki/build-reports/lock-protect-reports/)
- Compare submitted budget to actuals — see [Budget vs. Actuals Variance](/wiki/build-reports/budget-vs-actuals-variance/)
- Distribute the workbook via SharePoint — see [Share via Teams & SharePoint](/wiki/word-powerpoint/sharing/share-teams-sharepoint-onedrive/)
