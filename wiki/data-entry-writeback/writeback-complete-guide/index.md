...
url: "https://officeconnectpro.com/wiki/data-entry-writeback/writeback-complete-guide/"
...
- This article assumes you've already built basic OfficeConnect reports — start with [Build Your First Report](/wiki/build-reports/build-first-report/) if not.
...
The full step-by-step is in [Enter Budget Data](/wiki/data-entry-writeback/enter-budget-data/), but the short version:
...
- **Lock non-input cells.** Use Excel's **Protect Sheet** to lock everything except the input region. See [Lock and Protect Reports](/wiki/build-reports/lock-protect-reports/).
...
| *"Submit failed: timeout"* | Slow network or very large submit (hundreds+ cells) | Split the submit into batches; see [Optimize Performance](/wiki/performance/optimize-performance/) |
...
- [Enter Budget Data](/wiki/data-entry-writeback/enter-budget-data/) — full step-by-step tutorial.
...
- [Lock and Protect Reports](/wiki/build-reports/lock-protect-reports/) — protect the workbook before distributing.
