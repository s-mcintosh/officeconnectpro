...
url: "https://officeconnectpro.com/wiki/word-powerpoint/powerpoint/period-aware-charts/"
...
If you're new to PowerPoint linking, start with [OfficeConnect for PowerPoint](/wiki/word-powerpoint/powerpoint/officeconnect-for-powerpoint/).
...
In the Reporting pane, expand **Time** and find the relative version of your choice. Drag it into the header row of your chart's source range. See [Time and Contexts](/wiki/build-reports/time-and-contexts/) for the catalog of relative time elements.
{{< /step >}}
...
Name it `Narrative_Revenue_CurrentMonth`. Link the cell into a Word narrative or a PowerPoint text box. See [OfficeConnect for Word](/wiki/word-powerpoint/word/officeconnect-for-word/) — the qualitative-text refresh pattern is well-suited to this kind of period-aware narrative.
...
- [Designing a Board Pack Template](/wiki/word-powerpoint/powerpoint/board-pack-template/) — the slide template that hosts these charts.
- [Refreshing All Slides Safely](/wiki/word-powerpoint/powerpoint/refresh-all-slides/) — the refresh discipline that surfaces the updates.
- [Time and Contexts](/wiki/build-reports/time-and-contexts/) — the catalog of relative time elements that drive period awareness.
