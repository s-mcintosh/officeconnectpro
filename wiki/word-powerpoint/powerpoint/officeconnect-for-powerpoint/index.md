...
url: "https://officeconnectpro.com/wiki/word-powerpoint/powerpoint/officeconnect-for-powerpoint/"
...
After Workday OfficeConnect is installed (see [Install for End Users](/wiki/install-end-user/)), an **OfficeConnect** tab appears in PowerPoint's ribbon.
{{< /step >}}

{{< step n="2" title="Click Log In" >}}
Enter your Adaptive Planning credentials, or click **Log in with Workday**. If you're already signed in to OfficeConnect for Excel, PowerPoint logs you in automatically. See [Sign In & Create a Tenant](/wiki/admin/configure/sign-in-create-tenant/) if you haven't set up the connection yet.
{{< /step >}}
...
- [Publish to PowerPoint (full tutorial)](/wiki/build-reports/publish-to-powerpoint/) — a step-by-step walkthrough of building a deck.
- [OfficeConnect for Word](/wiki/word-powerpoint/word/officeconnect-for-word/) — the same workflow for narrative reports.
- [Share Reports via Teams, SharePoint & OneDrive](/wiki/word-powerpoint/sharing/share-teams-sharepoint-onedrive/) — distribute the final deck.
