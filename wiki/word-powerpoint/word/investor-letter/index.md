...
url: "https://officeconnectpro.com/wiki/word-powerpoint/word/investor-letter/"
...
This guide walks through building a reusable investor-letter Word template with Workday OfficeConnect-linked cells. It builds on the same pattern as [MD&A Automated Draft](/wiki/word-powerpoint/word/mda-automated-draft/); the difference is voice and structure.
...
Guidance comes from your latest forecast version in Adaptive Planning. See [Compare Planning Versions](/wiki/build-reports/compare-planning-versions/) if you maintain multiple forecast versions.
{{< /step >}}
...
For each section, use the OfficeConnect Word links pane to insert the named cells in place. See [OfficeConnect for Word](/wiki/word-powerpoint/word/officeconnect-for-word/) for the linking mechanics.
...
Once the CEO has finalized the narrative, you can optionally break the links to lock the file as a static historical record. See [Recovering Broken Links](/wiki/word-powerpoint/powerpoint/recovering-broken-links/) (the PowerPoint guide; the Word break-link procedure is similar via **Manage Links → Break Link**).
{{< /step >}}
...
- [MD&A Automated Draft](/wiki/word-powerpoint/word/mda-automated-draft/) — the related management-discussion document.
- [OfficeConnect for Word](/wiki/word-powerpoint/word/officeconnect-for-word/) — the underlying linking mechanics.
- [Charts That Update with the Period](/wiki/word-powerpoint/powerpoint/period-aware-charts/) — period-aware chart patterns for the accompanying deck.
