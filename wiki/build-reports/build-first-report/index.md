...
url: "https://officeconnectpro.com/wiki/build-reports/build-first-report/"
...
**What you'll need:**
- OfficeConnect installed and connected to your Workday tenant ([Get Started](/wiki/))
...
If the pane shows a sign-in prompt, click **Sign In** and complete the Workday authentication flow. See [Sign In and Create a Tenant](/wiki/admin/configure/sign-in-create-tenant/) if you need help.
{{< /step >}}
...
For more detail on each element type, see [Add Elements to a Report](/wiki/build-reports/add-elements/).
...
- **Add filters** to scope data to a specific department or cost center — see [Filter Data](/wiki/build-reports/filter-data/)
- **Repeat rows** to build multi-account reports automatically — see [Repeating Reports](/wiki/build-reports/repeating-reports/)
- **Share the report** with a colleague via SharePoint — see [Share via Teams & SharePoint](/wiki/word-powerpoint/sharing/share-teams-sharepoint-onedrive/)
