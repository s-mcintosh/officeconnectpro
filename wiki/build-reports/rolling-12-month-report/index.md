...
url: "https://officeconnectpro.com/wiki/build-reports/rolling-12-month-report/"
...
**What you'll need:**
- An existing OfficeConnect workbook or a blank one ([Build Your First Report](/wiki/build-reports/build-first-report/))
...
For repeating rows across many accounts, see [Repeating Reports](/wiki/build-reports/repeating-reports/).
...
- Share the finished report via SharePoint so the whole team always has the latest version — [Share via Teams & SharePoint](/wiki/word-powerpoint/sharing/share-teams-sharepoint-onedrive/)
