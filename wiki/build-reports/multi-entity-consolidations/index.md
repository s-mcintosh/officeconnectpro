...
url: "https://officeconnectpro.com/wiki/build-reports/multi-entity-consolidations/"
...
- An Eliminations entity or Level configured in your model — see [Intercompany Eliminations](/wiki/build-reports/financials/intercompany-eliminations/)
- Familiarity with selecting Levels in the Reporting pane ([Add Elements](/wiki/build-reports/add-elements/))
...
Click **Refresh**. Every entity column populates from Adaptive Planning. Spot-check the Consolidated Net Income against the official consolidated trial balance — see [Trial Balance Report](/wiki/build-reports/financials/trial-balance-report/) for the supporting view.
{{< /step >}}
...
- Dig into the elimination logic itself — see [Intercompany Eliminations](/wiki/build-reports/financials/intercompany-eliminations/)
- Pair this with a cash flow view — see [Cash Flow Statement](/wiki/build-reports/financials/cash-flow-statement/)
- Report in a single reporting currency across entities — see [Constant Currency Reporting](/wiki/build-reports/constant-currency-reporting/)
