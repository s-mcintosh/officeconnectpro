...
url: "https://officeconnectpro.com/wiki/build-reports/financials/intercompany-eliminations/"
...
> **Note:** The Exclude Elimination option is a Financials-only feature — it is not available in Adaptive Planning reports. See [Adaptive Planning vs. Financials Data Source](/wiki/migration-comparison/financials-vs-adaptive-planning/).
...
- [Drill Through to Workday Journal Lines](/wiki/build-reports/financials/drill-through-journal-lines/) — verify elimination journal entries
