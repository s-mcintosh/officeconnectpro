...
url: "https://officeconnectpro.com/wiki/build-reports/financials/cash-flow-statement/"
...
- A completed balance sheet workbook is helpful for cross-referencing — see [Build a Balance Sheet](/wiki/build-reports/financials/balance-sheet-report/)
...
- Cross-reference with your balance sheet — see [Build a Balance Sheet](/wiki/build-reports/financials/balance-sheet-report/)
- Add prior-year comparison columns to show YoY cash flow — see [Build an Actuals Trend Report](/wiki/build-reports/financials/actuals-trend-report/)
- Reconcile figures to Workday Report Writer — see [Reconcile OfficeConnect Values to Workday Reports](/wiki/build-reports/financials/reconcile-to-workday/)
