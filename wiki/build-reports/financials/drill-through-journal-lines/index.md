...
url: "https://officeconnectpro.com/wiki/build-reports/financials/drill-through-journal-lines/"
...
Open any OfficeConnect workbook using the Financials data source and click **Refresh** to ensure cells are populated. If you need to build one from scratch, follow [Build a Trial Balance Report](/wiki/build-reports/financials/trial-balance-report/) first.
{{< /step >}}
...
See [Adaptive Planning vs. Financials Data Source](/wiki/migration-comparison/financials-vs-adaptive-planning/) for a full comparison.

---

## Next steps

- Build a trial balance to have a full set of balances to drill into — see [Trial Balance Report](/wiki/build-reports/financials/trial-balance-report/)
- Build an actuals trend to find the period where a variance appears — see [Actuals Trend Report](/wiki/build-reports/financials/actuals-trend-report/)
