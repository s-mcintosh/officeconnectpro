...
url: "https://officeconnectpro.com/wiki/build-reports/formatted-executive-report/"
...
**What you'll need:**
- OfficeConnect installed and connected to an Adaptive Planning tenant ([Get Started](/wiki/))
- An Adaptive Planning model with P&L accounts, actuals, and budget loaded
- Basic familiarity with building variance reports — see [Budget vs. Actuals Variance](/wiki/build-reports/budget-vs-actuals-variance/)
...
- Share the PDF automatically — see [Share via Teams & SharePoint](/wiki/word-powerpoint/sharing/share-teams-sharepoint-onedrive/)
- Schedule the refresh automatically — see [Refresh Reports Automatically with Power Automate](/wiki/admin/configure/refresh-with-power-automate/)
- Add it to a PowerPoint deck — see [OfficeConnect for PowerPoint](/wiki/word-powerpoint/powerpoint/officeconnect-for-powerpoint/)
