...
url: "https://officeconnectpro.com/wiki/build-reports/cut-copy-move-elements/"
...
→ [Review & Verify Applied Elements](/wiki/build-reports/review-applied-elements/) to inspect which elements are driving each cell's data
