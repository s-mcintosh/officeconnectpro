...
url: "https://officeconnectpro.com/wiki/build-reports/kpi-dashboard/"
...
- Comfort dragging Account, Version, and Time elements ([Add Elements](/wiki/build-reports/add-elements/))
...
Once you're happy with the layout, protect the sheet so executives can't accidentally drag a tile out of place — see [Lock and Protect Reports](/wiki/build-reports/lock-protect-reports/).
{{< /step >}}
...
- Apply executive-grade formatting across the rest of your reporting pack — see [Formatted Executive Report](/wiki/build-reports/formatted-executive-report/)
- Push the dashboard into a slide deck — see [Publish to PowerPoint](/wiki/build-reports/publish-to-powerpoint/)
- Add a current vs. prior-year layer — see [Year-over-Year Trend Report](/wiki/build-reports/year-over-year-trend/)
