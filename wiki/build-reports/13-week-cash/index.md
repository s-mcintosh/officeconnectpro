...
url: "https://officeconnectpro.com/wiki/build-reports/13-week-cash/"
...
- Familiarity with time contexts ([Time and Contexts](/wiki/build-reports/time-and-contexts/))
...
Drop a second copy of the report on another tab and swap the version to a downside scenario (collections delayed 30 days, for example). Compare Ending Balances side by side. Cross-version comparisons are covered in [Scenario Comparison](/wiki/build-reports/scenario-comparison/).
{{< /step >}}
...
- Pair the cash forecast with the period close cash flow statement — see [Cash Flow Statement](/wiki/build-reports/financials/cash-flow-statement/)
- Make the rolling-period mechanic do the same job for monthly views — see [Rolling 12-Month Report](/wiki/build-reports/rolling-12-month-report/)
- Run downside scenarios alongside the base case — see [Scenario Comparison](/wiki/build-reports/scenario-comparison/)
